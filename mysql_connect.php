<?php 
 // 将数据库访问信息设置为常量：
DEFINE ('DB_USER', 'root');
DEFINE ('DB_PASSWORD', '101010lyhLYH*');
DEFINE ('DB_HOST', '112.74.57.28');
DEFINE ('DB_NAME', 'homework_system');
...
// sendmail('zhengjianhong95@gmail.com','郑建鸿','作业提醒','有新的作业布置了');
//sendmail('960404717@qq.com','郑建鸿','作业提醒','有新的作业布置了');
function sendmail($to,$user_name,$title,$content)
{
    ...
    try {
        ...
        $mail->Username = '960404717@qq.com';                 // SMTP username
        $mail->Password = 'pcghubnzbmilbbjh';                           // SMTP password
        $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
        $mail->Port = 587;                                    // TCP port to connect to

        //Recipients
        $mail->setFrom('960404717@qq.com', '校园课堂作品提交与互评系统');
        //$mail->addAddress('zhengjianhong95@gmail.com', 'Ryan Zheng');     // Add a recipient
